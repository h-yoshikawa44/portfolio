...
export const langAndframewarks = [
  {
    ...
    description: (
      <>
        基本的には研修で学んだ程度。<br />
        そのほか、FW のビューで記述したり、React の JSX（厳密には異なるが）で書いているなど。
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        つい最近、個人開発でReactのコードを書く上で使い始めた言語。<br />
